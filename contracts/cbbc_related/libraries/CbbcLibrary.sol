    ...
    */
    function _computePriceImpact(priceData memory priceData_,
        ...
        if(settleAmount == 0 && cbbcAmount == 0){
            ...
            uint amountAdjusted = (settleAmount + cbbcAmount * tempCbbcPrice / (10**18) * (10 ** cbbcTokenData_.settleTokenDecimals) /(10**18)) * cbbcTokenData_.leverage * settlePrice / (10 ** cbbcTokenData_.settleTokenDecimals) * (10 ** cbbcTokenData_.tradeTokenDecimals) / priceData_.currentPrice;
