...
// Copied and modified from YAM code:
    ...
    mapping (address => uint) public noncesForVote;
    ...
    */
        ...
        external
    {
        bytes32 domainSeparator = keccak256(
            abi.encode(
                DOMAIN_TYPEHASH,
                keccak256(bytes(IERC20(address(this)).name())),
                getChainId(),
                address(this)
            )
        );
        ...
        require(nonce == noncesForVote[signatory]++, "SUSHI::delegateBySig: invalid nonce");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = IERC20(address(this)).balanceOf(delegator); // balance of underlying SUSHIs (not scaled);
    ...
    modifier onlyInternalContracts() {
        ...
        require(isIssuerForCbbcToken || isIssuerForDividendToken || isIssuerForLiquidityToken || isIssuerForSatoshi || isMasterChef || isRouter, "Charm: Only Issuer or MasterChef contracts allowed");
        _;
    }
