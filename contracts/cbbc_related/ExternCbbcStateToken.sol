...
// Internal references
interface IExternCbbcStateToken{
...
contract ExternCbbcStateToken is Owned, Proxyable, IExternCbbcStateToken {
...
//    using SafeDecimalMath for uint;
    ...
    constructor(
        ...
        gonsPerFragment = _gonsPerFragment;
        decimals = _decimals;
    }
    ...
    function balanceOf(address account) public view returns (uint) {
        return tokenState.balanceOf(account)/gonsPerFragment;
    }
    ...
    function _internalTransfer(
        ...
        uint gons = value * gonsPerFragment;
        tokenState.setBalanceOf(from, tokenState.balanceOf(from) - gons);
        tokenState.setBalanceOf(to, tokenState.balanceOf(to) + gons);

        // Emit a standard ERC20 transfer event
        emitTransfer(from, to, gons);
    ...
    function _transferFromByProxy(
        ...
        uint gons = value * gonsPerFragment;
        tokenState.setAllowance(from, sender, tokenState.allowance(from, sender) - gons);
        return _internalTransfer(from, to, gons);
    }
