...
// ============== MUTATIVE FUNCTIONS ==============
        ...
        returns (uint256)
    {
        ...
        totalSupply = totalGons / gonsPerFragment;
        rebaseTimestamp = block.timestamp; // update rebase timestamp
        (rebasePrice,) = marketOracle().priceAndTimestamp(tradeTokenKey);
...
*/
    ...
    function _internalIssue(address account, uint amount) internal {
        tokenState.setBalanceOf(account, tokenState.balanceOf(account) + amount * gonsPerFragment);
    ...
    */
    function getCbbcPrice(
        ...
        public view override returns (uint) {
            ...
            cbbcTokenData_.tradeTokenDecimals = IERC20(tradeTokenAddress()).decimals();
            }
            {
            ...
            require(priceData_.currentPrice > 0, "CBBC: ILLEGAL_TRADE_PRICE.");// TODO: stale price??
