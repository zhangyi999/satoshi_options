...
contract DividendToken is BaseToken, IDividendToken {
    ...
    function issue(address account, uint amount, uint _burnedCharm) external override lock onlyInternalContracts {
        burnedCharm += _burnedCharm;
        _internalIssue(account, amount);
    }

    function burn(address account, uint amount, uint _burnedCharm) external override lock onlyInternalContracts returns(bool) {
        burnedCharm -= _burnedCharm;
